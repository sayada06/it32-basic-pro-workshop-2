...
if age <= 35 and height > 180 and strength > 8:
    print (f"ยินดีด้วย!!", name, "แกผ่านการคัดเลือกและตอนนี้แกได้เป็นหัวหน้าหน่วยของพวกเราแล้ว ฮะฮะฮ่าาาา" )
elif height > 180 or strength > 8:
    print (f"ยินดีด้วย!!", name, "แกผ่านการคัดเลือกและตอนนี้แกได้เป็นสมาชิกของพวกเราแล้ว ฮะฮะฮ่าาาา" )
elif age > 35 and strength > 5:
    print (f"ยินดีด้วย!!", name, "แกผ่านการคัดเลือกและตอนนี้แกได้เป็นภารโรงของพวกเราแล้ว ฮะฮะฮ่าาาา" )
else:
    print (f"แกมันช่างอ่อนด๋อยจริงๆเลยนะ", name, "แกไม่ผ่านไสหัวออกไปจากที่ของฉันซะ!")